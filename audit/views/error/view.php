...
echo CHtml::tag('div', array(
    'class' => 'source',
), CHtml::tag('p', array('class' => 'file'), htmlspecialchars($auditError->file, ENT_QUOTES, Yii::app()->charset) . '(' . $auditError->line . ')') . $auditError->source_code);

if ($auditError->stack_trace) {
    echo CHtml::tag('div', array(
        'class' => 'traces',
    ), CHtml::tag('h2', array(), Yii::t('audit', 'Stack Trace')) . $auditError->stack_trace);
}